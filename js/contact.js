...
var whiteSpace = /^[\s]+$/;
	if ( posText.value == '' || whiteSpace.test(posText.value) || posName.value == '' || posEmail.value == '' || posRegard.value == '' ) {
		alert("Looks like you've missed something. Make sure you fill in all the fields.");
	}
...
function hideContactTimer () {
	...
	document.getElementById("status").innerHTML = ''+grabPosXML("confirmation")+'';
